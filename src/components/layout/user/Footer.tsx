 ...
 * Footer component.
 *
 * Displays the Booky logo, a short tagline, and social media icon links.
 * Rendered at the bottom of all user-facing pages.
 */
    ...
    <footer className='bg-white mt-10 py-10 px-6 border-t border-gray-300 md:w-full md:p-18'>
      <div className='flex flex-col items-center gap-4 text-center'>
        ...
        <div className='flex items-center gap-3 md:mb-5'>
          ...
          <span className='text-4xl font-extrabold text-gray-900 md:text-3xl '>
            Booky
          </span>
        </div>
        ...
        <div className='flex flex-col items-center gap-3 mt-2'>
          <p className='text-lg font-extrabold text-gray-700 mb-2'>
